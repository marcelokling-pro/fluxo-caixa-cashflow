...
export default function App() {
  ...
  return (
    <div style={s.app}>
        ...
        {sidebarOpen&&(
          <div style={{padding:"16px 24px",borderTop:"1px solid #1E2D3D"}}>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <span style={{fontSize:10,color:"#6B8299",opacity:0.5,fontFamily:"monospace",letterSpacing:"0.3px"}}>FluxoCaixa v5.2.1 · by MKK</span>
          ...
          <>
            ...
            <div style={{...s.card,marginBottom:16}}>
              ...
              <div style={{display:"flex",gap:12,flexWrap:"wrap",alignItems:"center"}}>
                ...
                <div style={{fontSize:12,color:"#6B8299"}}>Versão: <span style={{color:"#00C9A7",fontWeight:600}}>FluxoCaixa280626_v5.2.1</span></div>
      ...
      <div style={{position:"fixed",bottom:6,right:12,fontSize:10,color:"#6B8299",opacity:0.5,zIndex:50,fontFamily:"monospace"}}>FluxoCaixa280626_v5.2.1 · by MKK</div>
